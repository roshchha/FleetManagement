...
namespace Microsoft.ApplicationBlocks.Data
{
    ...
    public sealed class SqlHelper
    {
        ...
        internal static string ConnectionString 
        {
            get
            {
                if (System.Configuration.ConfigurationManager.AppSettings["IsConnectionEncrypted"] != "false")
                {
                    return BusinessLayer.Common.Functions.Decrypt(System.Configuration.ConfigurationManager.ConnectionStrings["Default"].ConnectionString);
                }
                else
                {
        ...
        public static object ExecuteScalar(CommandType commandType, string commandText, params SqlParameter[] parameterValues)
        {
            return ExecuteScalar(ConnectionString,commandType,commandText,parameterValues);
        }
