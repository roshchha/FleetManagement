...
<table align="center">
<tr>
<td colspan="3" align="center"><h3>Vehicle Allocation</h3>
</td>
</tr>
<tr>
...
<td>
    <asp:DropDownList ID="ddlBookingid" runat="server" AutoPostBack="True">
...
<td>
    <asp:TextBox ID="txtDutyslipno" runat="server" ReadOnly="True"></asp:TextBox>
</td>
</tr>
<tr>
<td>
...
<td>
    <asp:TextBox ID="txtDutyslipdate" runat="server" ReadOnly="True"></asp:TextBox></td>
</tr>
<%--<tr>
<td>
    <asp:Label ID="lblPassengers" runat="server" Text="Passengers"></asp:Label></td>
<td>
    <asp:TextBox ID="txtPassengers" runat="server"></asp:TextBox></td>
</tr>--%>
<tr>
<td style="height: 26px">
    <asp:Label ID="lblGuestname" runat="server" Text="Guest Name"></asp:Label></td>
<td style="height: 26px">
    <asp:TextBox ID="txtGuestname" runat="server" ReadOnly="True"></asp:TextBox></td>
</tr>
<tr>
<td style="height: 26px">
...
<td>
    <asp:TextBox ID="txtDriverallot" runat="server"></asp:TextBox>
</td>
</tr>--%>
