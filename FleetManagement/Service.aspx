...
<tr>
<td><asp:Label ID="lblDate" runat="server" Text="Service sent date" meta:resourcekey="lblLastnameResource1"></asp:Label></td>
<td>
    <asp:TextBox ID="txtServicingdate" runat="server" onclick="ds_sh(this)" onfocus="ds_sh(this)"></asp:TextBox></td>
<td style="width: 114px"><asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="*" ControlToValidate="txtServicingdate" meta:resourcekey="RequiredFieldValidator2Resource1" SetFocusOnError="True">Date Required</asp:RequiredFieldValidator></td>
</tr>
<tr>
<td><asp:Label ID="lblMeterreading" runat="server" Text="Meter Reading"></asp:Label></td>
<td>
    <asp:TextBox ID="txtMeterReading" runat="server" MaxLength="12"></asp:TextBox>
    </td>
<td style="width: 114px"><asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ErrorMessage="*" ControlToValidate="txtMeterReading" meta:resourcekey="RequiredFieldValidator3Resource1" SetFocusOnError="True"></asp:RequiredFieldValidator>
...
<tr>
<td style="height: 40px"><asp:Label ID="lblReasonforservice" runat="server" Text="Reason for Service" meta:resourcekey="lblDateofjoinResource1"></asp:Label></td>
<td style="height: 40px">
    <asp:TextBox ID="txtReasonforservice" runat="server" TextMode="MultiLine"></asp:TextBox>
   </td>
<td style="height: 40px; width: 114px;"><asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ErrorMessage="*" ControlToValidate="txtReasonforservice" meta:resourcekey="RequiredFieldValidator5Resource1">Reason Required</asp:RequiredFieldValidator></td>
</tr>
<tr>
<td><asp:Label ID="lblSaparesexpenditure" runat="server" Text="Expenditure on Spares" meta:resourcekey="lblQualificationResource1"></asp:Label></td>
<td>
    <asp:TextBox ID="txtExpenditureonspares" runat="server" MaxLength="10"></asp:TextBox>
    </td>
<td style="width: 114px"><asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ErrorMessage="*" ControlToValidate="txtExpenditureonspares" meta:resourcekey="RequiredFieldValidator6Resource1"></asp:RequiredFieldValidator>
...
<tr>
<td><asp:Label ID="lblLabourexpenditure" runat="server" Text="Expenditure on Manpower" meta:resourcekey="lblDateofbirthResource1"></asp:Label></td>
<td>
    
    <asp:TextBox ID="txtExpenditureonmanpower"  runat="server" MaxLength="8"></asp:TextBox></td>
<td style="width: 114px"><asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server" ErrorMessage="*" ControlToValidate="txtExpenditureonmanpower"></asp:RequiredFieldValidator>
...
<tr>
<td><asp:Label ID="lblDuedate" runat="server" Text="Next Service Date" ></asp:Label></td>
<td>
    <asp:TextBox ID="txtNextservicedate" runat="server" onclick="ds_sh(this)" onfocus="ds_sh(this)" ></asp:TextBox></td>
<td style="width: 114px"><asp:RequiredFieldValidator ID="RequiredFieldValidator8" runat="server" ErrorMessage="*" ControlToValidate="txtNextservicedate" meta:resourcekey="RequiredFieldValidator8Resource1">Date Required</asp:RequiredFieldValidator></td>
</tr>
...
<td>
    <asp:TextBox ID="txtContactno" runat="server" meta:resourcekey="txtContactnoResource1"></asp:TextBox></td>
