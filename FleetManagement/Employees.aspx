...
<table align="center">
<tr>
<td colspan="3" align="center"><h3>Add Employee Details</h3>
</td>
</tr>
<tr>
...
<td>
    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="*" ControlToValidate="txtFirstname" meta:resourcekey="RequiredFieldValidator1Resource1" SetFocusOnError="True">Firstname Required</asp:RequiredFieldValidator></td>
</tr>
<tr>
<td><asp:Label ID="lblLastname" runat="server" Text="Last Name" meta:resourcekey="lblLastnameResource1"></asp:Label></td>
<td>
    <asp:TextBox ID="txtLastName" runat="server" meta:resourcekey="txtLastNameResource1"></asp:TextBox></td>
<td><asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="*" ControlToValidate="txtLastName" meta:resourcekey="RequiredFieldValidator2Resource1" SetFocusOnError="True">Lastname Required</asp:RequiredFieldValidator></td>
</tr>
<tr>
<td><asp:Label ID="lblDesignation" runat="server" Text="Designation" meta:resourcekey="lblDesignationResource1"></asp:Label></td>
<td>
    <asp:DropDownList ID="ddlDesignation" runat="server" meta:resourcekey="ddlDesignationResource1">
...
<td><asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ErrorMessage="*" ControlToValidate="ddlDesignation" meta:resourcekey="RequiredFieldValidator3Resource1" SetFocusOnError="True">Select</asp:RequiredFieldValidator></td>
</tr>
<tr>
<td><asp:Label ID="lblSalery" runat="server" Text="Salery" meta:resourcekey="lblSaleryResource1"></asp:Label></td>
<td>
    <asp:TextBox ID="txtSalery" runat="server" meta:resourcekey="txtSaleryResource1" MaxLength="12"></asp:TextBox></td>
<td><asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ErrorMessage="*" ControlToValidate="txtSalery" meta:resourcekey="RequiredFieldValidator4Resource1"></asp:RequiredFieldValidator><asp:CompareValidator
...
<tr>
<td><asp:Label ID="lblDateofjoin" runat="server" Text="Date of Join" meta:resourcekey="lblDateofjoinResource1"></asp:Label></td>
<td>
   <input onclick="ds_sh(this);" name="date" onfocus="ds_sh(this)"  runat="server" style="cursor: text"  id="txtJoiningdate" readonly="readOnly" /></td>
<td><asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ErrorMessage="*" ControlToValidate="txtJoiningdate" meta:resourcekey="RequiredFieldValidator5Resource1">Date Required</asp:RequiredFieldValidator></td>
</tr>
<tr>
<td><asp:Label ID="lblQualification" runat="server" Text="Qualification" meta:resourcekey="lblQualificationResource1"></asp:Label></td>
<td>
    <asp:DropDownList ID="ddlQualification" runat="server" meta:resourcekey="ddlQualificationResource1">
...
<td><asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ErrorMessage="*" ControlToValidate="ddlQualification" meta:resourcekey="RequiredFieldValidator6Resource1">Select</asp:RequiredFieldValidator></td>
</tr>
<tr>
<td><asp:Label ID="lblDateofbirth" runat="server" Text="DOB" meta:resourcekey="lblDateofbirthResource1"></asp:Label></td>
<td>
    
    <asp:TextBox ID="txtDob" onclick="ds_hh(this)" onfocus="ds_hh(this)"  runat="server"></asp:TextBox></td>
<td><asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server" ErrorMessage="*" ControlToValidate="txtDob">Date Required</asp:RequiredFieldValidator></td>
</tr>
<tr>
<td><asp:Label ID="lblAddress" runat="server" Text="Address" meta:resourcekey="lblAddressResource1"></asp:Label></td>
<td>
    <asp:TextBox ID="txtAddress" runat="server" TextMode="MultiLine" meta:resourcekey="txtAddressResource1"></asp:TextBox></td>
<td><asp:RequiredFieldValidator ID="RequiredFieldValidator8" runat="server" ErrorMessage="*" ControlToValidate="txtAddress" meta:resourcekey="RequiredFieldValidator8Resource1">Address Required</asp:RequiredFieldValidator></td>
</tr>
...
<td>
    <asp:TextBox ID="txtContactno" runat="server" meta:resourcekey="txtContactnoResource1" MaxLength="13"></asp:TextBox></td>
...
<td>
    <asp:TextBox ID="txtEmailid" runat="server" meta:resourcekey="txtEmailidResource1"></asp:TextBox></td>
...
<tr>
 <td colspan="3" align="center">
   <asp:Button ID="btnSubmit" runat="server" Text="Submit" OnClick="btnSubmit_Click" meta:resourcekey="btnSubmitResource1" />&nbsp;
    <asp:Button ID="btnBack" runat="server" Text="Back" PostBackUrl="~/Home.aspx" CausesValidation="False" meta:resourcekey="btnBackResource1" />
    </td>  
    </tr>
