...
namespace FleetManagement.DS_CustomersTableAdapters {
    ...
    public partial class customersTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [customers] ([name], [address], [phone], [email], [country], [state])" +
                " VALUES (@name, @address, @phone, @email, @country, @state)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT        id, name, address, phone, email, country, state\r\nFROM            cu" +
                "stomers";
        ...
        public virtual int Fill(DS_Customers.customersDataTable dataTable) {
        ...
        public virtual DS_Customers.customersDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            DS_Customers.customersDataTable dataTable = new DS_Customers.customersDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(DS_Customers.customersDataTable dataTable) {
        ...
        public virtual int Insert(string name, string address, string phone, string email, string country, string state) {
            if ((name == null)) {
